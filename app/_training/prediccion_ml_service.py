...
class PrediccionMLService:
    ...
    def __init__(
        self,
        ruta_modelo: str = "./generated-model/model.pkl",
        ruta_encoder: str = "./generated-model/label_encoder_ubicacion.pkl",
        ruta_features: str = "./generated-model/features_list.pkl",
